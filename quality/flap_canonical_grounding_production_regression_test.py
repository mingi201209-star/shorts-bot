...
def run():
    ...
    fresh_process = textwrap.dedent(
        ...
        evidence = winner.get("_trusted_grounding_evidence") or {{}}
        claims = evidence.get("supported_claims") or winner.get("supported_claims") or []
        ...
        unrelated_evidence = unrelated.get("_trusted_grounding_evidence") or {{}}
        unrelated_ids = {{
            str(c.get("claim_id", ""))
            for c in (unrelated_evidence.get("supported_claims") or [])
