...
PRODUCTION_TRUSTED_SUBJECT_IDENTITY_RECORDS: tuple[Dict[str, Any], ...] = (
    {
        ...
        "seed_candidate": {
            ...
            "core_question": "비행기 엔진 뒤쪽 가장자리는 왜 톱니 모양으로 되어 있을까?",
            "micro_narrative": {
                "hook": "비행기 엔진 뒤쪽 가장자리를 보면 톱니처럼 생긴 모양이 보입니다.",
                "core_question": "왜 매끈한 원 대신 톱니 모양으로 만들어 놓았을까요?",
                "reveal": "엔진 뒤에서는 뜨거운 배기 흐름과 차가운 바깥 흐름이 만나는데, 톱니 모양 가장자리는 두 흐름이 섞이는 방식을 바꿔 경계가 더 점진적으로 섞이도록 만듭니다.",
                "payoff": "이 혼합 변화의 대표적인 결과는 제트 엔진 소음 감소입니다.",
            },
            "fact_check_focus": [
                "톱니 가장자리가 배기 흐름과 주변 흐름의 혼합 방식을 바꾸는 점",
                "혼합 변화가 소음 감소로 이어지는 점",
            ],
            "visual_proof": ["비행기 제트 엔진 나셀 또는 노즐 뒤쪽의 톱니 모양 가장자리"],
            "selection_reason": "엔진 뒤 톱니 모양이라는 눈에 잘 보이는 디테일 뒤에 실제 소음 저감 설계 원리가 있습니다.",
            "specific_observation": "비행기 제트 엔진 나셀 또는 노즐 뒤쪽 가장자리가 톱니 모양입니다.",
            "constraint": "엔진 뒤에서는 뜨거운 배기 흐름과 차가운 바깥 흐름이 만나 소음의 원인이 되는 난류가 생깁니다.",
            "counterintuitive_result": "톱니 모양의 목적은 장식이 아니라 두 흐름이 섞이는 방식을 바꾸는 것입니다.",
            "tradeoff": "",
            "concrete_condition": "제트 엔진 배기 흐름과 주변 공기가 만나는 노즐/나셀 후단에 적용됩니다.",
        },
    },
)
