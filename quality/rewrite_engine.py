...
============================================================
- 정상 영역은 최대한 보존한다.
- 모든 한국어 Scene 대사는 격식체 존댓말로 끝낸다. 평서문은 ~습니다/~입니다/~합니다/~됩니다/~있습니다 계열만 사용한다.
- 해요체인 ~요/~해요/~돼요/~이에요/~예요/~죠/~세요는 사용하지 않는다. 특히 "알고 계셨나요?" 형태로 Hook을 바꾸지 않는다.
- 질문은 자연스러운 ~까요?만 허용하며, 원문이 격식체 평서문이면 가능하면 질문형으로 바꾸지 않는다.
