...
============================================================
3B. ENUMERATE-THEN-DISCARD (내부 절차, 출력하지 않음)
============================================================

대상 하나를 고르면,
Candidate로 확정하기 전에
그 대상에 대해 사람들이 흔히 아는
메커니즘/설명을 최소 3개 먼저 나열하라
(이 나열은 최종 출력에 포함하지 않는다.
너의 내부 사고 과정일 뿐이다).
...
이 목록에 있는 설명은
이미 시청자 대부분이 예상할 수 있는 답이다.

Core Question과 Reveal이
이 목록에 있는 설명 중 하나로
요약되거나 거의 동일하다면
그 Candidate는 폐기하라.
...
두 번째 층위의 질문이 바로 떠오르지 않는다고
대상 자체를 포기하지 마라.

먼저 나열한 뻔한 설명 각각에 대해
"그런데 정확히 언제/얼마나/어떤 조건에서
그렇게 되는가?"를 한 번 더 물어보고
그래도 답이 나오지 않을 때만
다른 대상으로 넘어가라.
