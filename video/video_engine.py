...
def get_safe_korean_font(size):
    ...
    # --------------------------------------------------------
    # 한글 폰트가 없으면 절대 기본 폰트를 쓰지 않는다.
    #
    # PIL 기본 폰트는 한글을 지원하지 않아
    # □□□□ 형태로 출력될 수 있다.
    # --------------------------------------------------------
